...
class _ShopPageWidgetState extends State<ShopPageWidget>
  ...
  static const List<Map<String, dynamic>> _curatedProducts = [
    ...
    },
    {
      ...
      'is_featured': false,
      'affiliate_url': 'https://www.amazon.com/s?k=garden+hese+wand&tag=sprouttogether-20',
...
/// Per-product image overrides â checked before the DB image_url.
...
const _kShopProductImageOverrides = <String, String>{
  ...
  'Raised Garden Bed - 4x4 Cedar':
      'https://images.unsplash.com/photo-1665395131699-f904d110acf5?w=400&q=80&fit=crop',
  // ââ PEST CONTROL âââââââââââââââââââââââââââââââââââââââââââââââââââââââââ
  ...
  'Outlet Timer for Grow Lights':
      'https://images.unsplash.com/photo-1505253758473-96b7015fcd40?w=400&q=80&fit=crop',
  // ââ OUTDOOR LIGHTING âââââââââââââââââââââââââââââââââââââââââââââââââââââ
