  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case GardenJournalEntriesRow:
            return GardenJournalEntriesRow(data);
          case GardenPlotsRow:
            return GardenPlotsRow(data);
          case GardenTasksRow:
            return GardenTasksRow(data);
          case GardensRow:
            return GardensRow(data);
          case PlantCompanionsRow:
            return PlantCompanionsRow(data);
          case PlantsRow:
            return PlantsRow(data);
          case ProfilesRow:
            return ProfilesRow(data);
          case UserSelectedPlantsRow:
            return UserSelectedPlantsRow(data);
          default:
            return null;
        }
